...
import { Bars3Icon, ChevronLeftIcon, PlusCircleIcon, UserCircleIcon } from 'react-native-heroicons/outline'
...
: <View/>}
      ...
      <Text style={{color : 'white', fontSize : 24, textAlign : 'center',fontWeight: "bold" }}>{"Trending"}</Text>
      </TouchableOpacity>
      {isLogged ?
      ...
      >
           ...
           :<TouchableOpacity onPress={() => router.replace('/login')} style={{marginRight : 8}}
           >
                    <UserCircleIcon size= "38" strokeWidth = {2} color={"#80c04e"}   />
      ...
      <SearchBar/>
        ...
        <LogOutButton modalVisible={modalVisible} setModalVisible={setModalVisible} />
