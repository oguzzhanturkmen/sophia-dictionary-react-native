...
const apiCall = async (endpoint , params) => {
    ...
    export const postTopic = (data) => apiPostCall("http://localhost:8084/main/post", data);
    export const postEntry = (data, postId) => apiPostCall("http://localhost:8084/topic/" + postId + "/post", data);
    export const getUserDataForProfile = () => apiCallAuthorized(`http://localhost:8084/auth/user`);
    export const getUserDataForOtherProfiles = (id) => apiCallAuthorized(`http://localhost:8084/user/get/${id}`);
